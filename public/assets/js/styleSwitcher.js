...
(function($) {
    ...
    sidebarStyleSelect.on('change', function() {
		...
		/* if(body.attr('data-sidebar-style') === 'icon-hover') {
            $('.deznav').unbind().on('hover',function() {

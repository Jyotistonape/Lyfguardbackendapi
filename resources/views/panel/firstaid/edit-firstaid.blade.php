            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{route('updateFirstAid', $data['firstaid']->id)}}" method="post"  enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-xl-10">
                                            ...
                                            <select id="single-select"
                                                ...
                                                @if($data['categories'])
                                                    @foreach($data['categories'] as $category)
                                                        <option value="{{$category->id}}" {{($data['firstaid']->cat_id == $category->id) ? 'selected' : ''}}>{{$category->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            @error('category')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text"
                                                   ...
                                                   value="{{ $data['firstaid']->title }}" id="val-name" name="title"
                                        ...
                                        <div class="col-lg-8">
                                            <textarea type="text"
                                                   ...
                                                   id="val-username" name="description"
                                                      placeholder="Enter Description" required>{{$data['firstaid']->description}}</textarea>
                                            @error('description')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text"
                                                   ...
                                                   value="{{ $data['firstaid']->video_link }}" id="val-video_link" name="video_link"

            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{route('updateDriver', $data['driver']->id)}}" method="post"  enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-xl-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text"
                                                   ...
                                                   value="{{ $data['driver']->name }}" id="val-name"
                                                   name="name"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text"
                                                   ...
                                                   value="{{ $data['driver']->licence_number }}" id="val-website" name="licence_number"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text"
                                                   ...
                                                   value="{{ $data['driver']->blood_group }}" id="val-blood_group" name="blood_group"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="number"
                                                   ...
                                                   value="{{ $data['driver']->phone }}" id="val-phone" name="username"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-2 ml-auto">
                                            <a class="btn btn btn-success" href="{{ route('listDriver') }}">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>

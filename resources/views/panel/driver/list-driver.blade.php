        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h4 class="card-title">
                        <a href="{{route('createDriver')}}" class="btn btn-primary">Add Driver <span class="btn-icon-right"><i class="fa fa-plus-square"></i></span>
                        </a>
                    </h4>
                </div>
                <div class="card-body">
                            ...
                            @if($data['drivers'])
                                @foreach($data['drivers'] as $driver)
                                    <tr>
                                        ...
                                        <td>{{$driver->state}}</td> -->
                                        <td>
                                            <a href="{{route('editDriver', $driver->id)}}" class="btn btn-sm btn-success"><i class="flaticon-381-edit-1"></i></a>

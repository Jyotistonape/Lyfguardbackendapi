            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{route('storeDriver')}}" method="post"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text"
                                                   ...
                                                   value="{{ old('licence_number') }}" id="val-website" name="licence_number"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text"
                                                   ...
                                                   value="{{ old('blood_group') }}" id="val-blood_group" name="blood_group"

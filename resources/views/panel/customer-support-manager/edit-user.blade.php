            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-validation">
                       <form class="form-valide" action="{{route('updateCustomerSupport', $data['user']->id)}}" method="post"  enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-xl-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="password"
                                                   ...
                                                   value="{{ $data['user']->password }}" id="val-confirm-password" name="password_confirmation"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-2 ml-auto">
                                            <a class="btn btn btn-success" href="{{ route('listCustomerSupport') }}">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>

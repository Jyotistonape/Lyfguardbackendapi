            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{route('storeCustomerSupport')}}" method="post"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="password"
                                                   ...
                                                   value="{{ old('password_confirmation') }}" id="val-confirm-password" name="password_confirmation"

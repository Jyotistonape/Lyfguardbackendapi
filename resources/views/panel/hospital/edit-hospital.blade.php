            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{route('updateHospital', $data['hospital']->id)}}" method="post"
                              enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <input type="hidden" value="{{ $data['hospital']->userID }}" name="admin_id" required>
                            <div class="row">
                                <div class="col-xl-10">
                                            ...
                                            <select id="single-select"
                                                ...
                                                @if($data['types'])
                                                    @foreach($data['types'] as $type)
                                                        <option value="{{$type->id}}" {{($data['hospital']->type_id == $type->id) ? 'selected' : ''}}>{{$type->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            @error('type')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text"
                                                   ...
                                                   value="{{ $data['hospital']->name }}" id="val-name"
                                                   name="hospital_name"
                                        ...
                                        <div class="col-lg-8">
                                            <input type="file"
                                                   ...
                                                   placeholder="Enter Logo" accept="image/*">
                                                    @if(!empty($data['hospital']->logo))
                                                   <img src="{{asset('storage/'. $data['hospital']->logo)}}" width="100px" height="100px">
                                                    @endif
                                            @error('logo')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="file"
                                                   ...
                                                   @if(!empty($data['hospital']->banner))
                                                   <img src="{{asset('storage/'. $data['hospital']->banner)}}" width="100px" height="100px">
                                                    @endif
                                            @error('banner')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="url"
                                                   ...
                                                   value="{{ $data['hospital']->website }}" id="val-website" name="website"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text"
                                                   ...
                                                   value="{{ $data['hospital']->userName }}" id="val-name" name="name"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="email"
                                                   ...
                                                   value="{{ $data['hospital']->userEmail }}" id="val-username" name="username"

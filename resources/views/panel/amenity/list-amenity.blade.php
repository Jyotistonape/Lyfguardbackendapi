        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h4 class="card-title">
                        <a href="{{route('createAmenity')}}" class="btn btn-primary">Add Amenity  <span class="btn-icon-right"><i class="fa fa-plus-square"></i></span>
                        </a>
                    </h4>
                </div>
                <div class="card-body">
                            ...
                            @if($data['amenities'])
                                @foreach($data['amenities'] as $amenity)
                                    <tr>
                                        ...
                                        <td>{{$amenity->price}}</td>
                                        <td>
                                            <a href="{{route('editAmenity', $amenity->id)}}" class="btn btn-sm btn-success"><i class="flaticon-381-edit-1"></i></a>
                                            <form action="{{route('deleteAmenity', $amenity->id)}}" method="post"

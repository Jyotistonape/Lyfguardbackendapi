            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{route('updateAmenity', $data['amenity']->id)}}" method="post"  enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-xl-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-2 ml-auto">
                                            <a class="btn btn btn-success" href="{{ route('listAmenity') }}">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>

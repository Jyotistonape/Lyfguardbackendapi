        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h4 class="card-title">
                        <a href="{{route('createService')}}" class="btn btn-primary">Add Service  <span class="btn-icon-right"><i class="fa fa-plus-square"></i></span>
                        </a>
                    </h4>
                </div>
                <div class="card-body">
                            ...
                            @if($data['services'])
                                @foreach($data['services'] as $service)
                                    <tr>
                                        ...
                                        <td class="data-trim" style="min-width:150px;"><span>{{$service->description}}</span></td>
                                        <td>
                                            @if($service->is_emergency == 1)
                                                <span>Yes</span>
                                                @else
                                                <span>No</span>
                                                @endif
                                        ...
                                        <td>
                                            <a href="{{route('editService', $service->id)}}" class="btn btn-sm btn-success"><i class="flaticon-381-edit-1"></i></a>

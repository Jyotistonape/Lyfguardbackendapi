            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-validation">
                       <form class="form-valide" action="{{route('updatePrivateAmbulance', $data['ambulance']->id)}}" method="post"  enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-xl-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text"
                                                   ...
                                                   value="{{ $data['ambulance']->insurance_date }}" id="insurance_date"
                                                   name="insurance_date"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="file"
                                                   ...
                                                   value="{{ old('registration_certificate') }}" id="registration_certificate" name="registration_certificate">
                                                   
                                                   @if(!empty($data['ambulance']->registration_certificate))

                                                   @if(pathinfo($data['ambulance']->registration_certificate, PATHINFO_EXTENSION) == 'pdf')
                                                   <a href="{{asset('storage/'. $data['ambulance']->registration_certificate)}}" target="_blank">View Link</a>
                                                   @else
                                                   <img src="{{asset('storage/'. $data['ambulance']->registration_certificate)}}" width="100px" height="100px">
                                                   @endif
                                                   @endif
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="number"
                                                   ...
                                                   value="{{$data['ambulance']->zero_five_km_rate}}" name="0_5km_rate"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="number"
                                                   ...
                                                   value="{{ $data['ambulance']->five_fifteen_km_rate }}" name="5_15km_rate"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="number"
                                                   ...
                                                   value="{{ $data['ambulance']->fifteen_thirty_km_rate }}" name="15_30km_rate"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="number"
                                                   ...
                                                   value="{{ $data['ambulance']->thirty_above_km_rate }}" name="30_abovekm_rate"
...
//                minDate: "dateToday",
    ...
    <script>
        $(document).ready(function () {
            ...
            $("body").on("change", ".amenity", function () {
